...
const FootArr = [
    {
        head : "glowup",
        arr : ["Who are we?","Careers","Authenticity","Press","Testimonials","glowup CSR","Responsible Disclosure","Investor Relations"]
    },
    {
        head :  "Help" ,
        arr :  [
            "Contact Us","Frequently asked questions","Store Locator","Cancellation & Return","Shipping & Delivery","Sell on glowup"
        ],
    },
    {
        head : "Inspire Me",
        arr : [
            "Beauty Book","glowup TV","glowup Network","Buying Guides"
        ]
    },
    {
        head : "Quick Links",
        arr :  [
            "Offer Zone","New Launches","glowup Man","glowup Fashion","glowup Pro"
        ]
    },
    {
        head : "Top Categories",
    ...
    return <SimpleGrid color='white'>
        <SimpleGrid bg='#3f414d' style={{
            ...
            <SimpleGrid gap={"8px"} display='flex'>
                <PhoneIcon />
                <SimpleGrid gap="8px">
                    <Heading as='h2' size='14px' > experience the glowup mobile app</Heading>
        ...
        <SimpleGrid bg="#fc2779"  padding='30px'  >
            ...
            <Text margin={"auto"} fontSize='md'>© 2023  glowup E-Retail Pvt. Ltd. All Rights Reserved.</Text>
        </SimpleGrid>
    </SimpleGrid>
}
