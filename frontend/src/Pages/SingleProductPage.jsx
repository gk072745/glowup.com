			...
			<Box bgColor={"#f3f3f3"} px={"100px"}>
				<Box w="full">
					...
					>
						...
						<Icon as={ChevronRightIcon}></Icon> singleProduct
					</Text>
				</Box>
						...
						<Box>
							...
							>
								<Text
									...
									fontWeight={500}
								>
									Nykaa Skin Secrets Gold Sheet Mask + Nykaa
									Skin Potion 24k Gold Facial Oil Golden Glow
									Combo
								</Text>
								<Text
									w="full"
							...
							<Box>
								...
								>
									<Text
										...
										fontSize={"16px"}
									>
										Lippie Pencil A long-wearing and
										high-intensity lip pencil that glides on
										easily and prevents feathering. Many of
										our Lippie Stix have a coordinating
										Lippie Pencil designed to compliment it
										perfectly, but feel free to mix and
										match!
									</Text>
							...
							<Box bgColor={"#fff"}>
								...
								>
									...
									<Text
										...
										color="#001325"
									>
										Agaro Rex DLX Sonic Electric Toothbrush
										For
									</Text>
									<HStack>
										<Text
