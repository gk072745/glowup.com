...
const SingleProductPage = () => {
	...
	const handleAddcart = (id) => {
		...
		axios
			.post(
				`https://periwinkle-sheep-hem.cyclic.app/cart/add/${id}`,
				null,
				{
					headers: {
	...
	const handleAddWishlist = (id) => {
		...
		axios
			.post(
				`https://periwinkle-sheep-hem.cyclic.app/wishlist/add/${id}`,
				null,
				{
					headers: {
						Authorization: Cookies.get("jwt_token"),
									...
									<TabPanels w="full">
										<TabPanel w="full">
											...
											>
												...
												<HStack
													alignItems={"flex-start"}
													className="removeRevidsfaf"
													spacing="30px"
													w="full"
												>
													<VStack
														className="reviewuserprofilemanage"
														w="30%"
													>
														<Text
															fontWeight={600}
